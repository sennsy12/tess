...
export function AdminAdvancedAnalytics() {
  ...
  return (
    <Layout title="Admin Avansert Analyse">
        ...
        <div className="lg:col-span-1 space-y-6 min-w-0">
          ...
          <div className="card overflow-visible">
            ...
            <div className="space-y-4">
              ...
              {/* Export */}
              <div className="pt-4">
                <ExportButton targetRef={chartRef} filename={`admin-analyse-${config.metric}-${config.dimension}`} />
              </div>
            </div>
          </div>
          ...
          <SavedViewsPanel
            ...
            description="Lagre dimensjon, måltall, datoer og søk. Del oppsett med andre administratorer."
            views={views}
            isLoading={viewsLoading}
