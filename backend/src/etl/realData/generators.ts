export function generateRealisticCustomers() {
...
export function generateRealisticFirms() {
  return [
...
export function generateRealisticProducts() {
  const products = [];
  let counter = 1;
...
export function generateRealisticOrders(kunder: any[], firmaer: any[], lager: any[], varer: any[]) {
  const orders = [];
